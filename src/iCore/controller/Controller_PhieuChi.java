...
public class Controller_PhieuChi extends PhieuChi implements ZEController {
	ObjectDAO dao = new DAO_PhieuChi();

	String timKiemTheo;
	String tuKhoa;
	String duongDanTrang = "iCore/pages/phieuchis.jsp";
	String duongDanTrangView = "iCore/pages/phieuchi.jsp";
	String tenCotTimDoiTuong = "maPC";
	String maObj;
	String s_ngayTao;
	...
	public String viewDetail() {
		...
		ArrayList<PhieuChi> arr = dao.listByColumnLike(tenCotTimDoiTuong, maobj);
		if (arr.size() > 0) {
	...
	public String search() {
		...
		ArrayList<PhieuChi> arr = dao.listByColumnLike(column, key);
