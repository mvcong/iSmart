...
/**
 * Servlet implementation class File_ExportSP
 */
@WebServlet("/Servlet_FileExportSP")
public class File_ExportSP extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public File_ExportSP() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String tenFile = "DANH_SACH_SAN_PHAM " + dateString + "".concat(".xls");
		// tao file excel
		HSSFWorkbook myWorkBook = new HSSFWorkbook();
		
		ArrayList<SanPham>sanphams = new DAO_SanPham().listAll();
		
		CreateSheet(myWorkBook, sanphams);
	...
	private void CreateSheet(HSSFWorkbook myWorkBook, ArrayList<SanPham> sanphams) {
			...
			for (int i = 0; i < sanphams.size(); i++) {
				...
				cell = row.createCell(3, CellType.STRING);
				cell.setCellValue(sp.getNgayNhapHang());
				cell.setCellStyle(styleConten);
				
				cell = row.createCell(4, CellType.STRING);
				cell.setCellValue(sp.getGiaSP());
				cell.setCellStyle(styleConten);
					
				cell = row.createCell(5, CellType.STRING);
				cell.setCellValue(sp.getNhanVien().getTenNV());
				cell.setCellStyle(styleConten);
				rowst++;
