...
public class DangKyTapNgayServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			theTVDAOImpl.dangKyThang(new TheThanhVien(maThe, new Date(), new Date(), hsd, loaiThe, new Date(), null));
			url = "/trangchu.jsp";
		} catch (Exception e) {
			e.printStackTrace();
			url = "/dangkytapngay.jsp";
		}
