...
// quản lý tài khoản	
	...
	// quản lý sản phẩm
		...
		ChucNang CN_QuanLyLoaiSP = new ChucNang();
		CN_QuanLyLoaiSP.setMaChucNang("QuanLyLoaiSP");
		CN_QuanLyLoaiSP.setDuongDan("iCore/pages/loaisanphams.jsp");
		CN_QuanLyLoaiSP.setHinhAnh("fa fa-share-alt");
		CN_QuanLyLoaiSP.setTenHienThi("Quản lý loại sản phẩm");
		CN_QuanLyLoaiSP.setChucNangCha(CN_QuanLySP);
		daochucnang.saveOrUpdate(CN_QuanLySanPham);
