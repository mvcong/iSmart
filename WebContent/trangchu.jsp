...
<link rel="stylesheet" href="content/home/css/nivo_themes/default/default.css">
<!-- Font Awesome Style -->
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse1">
        ...
        <li class="nav-item"> <a class="nav-link" href="trangsanpham.jsp">Cửa hàng</a> </li>      
         <li class="nav-item"> <a class="nav-link" href="dangnhap.jsp">Đăng nhập</a> </li>      
          <li class="nav-item"> <a class="nav-link" href="dangky.jsp">Đăng ký</a> </li>         
        </ul>
      </div>
            </div>
    </nav>
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4"> <img src="content/home/img/side-01.jpg" class="img-fluid" /> </div>
    </div>
    <!-- /.row --> 
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="heading text-md-center text-xs-center">
      ...
      <div class="col-md-4 blog-box">
        <div class="blog-image-block"> <img src="content/home/img/blog-01.jpg" alt="" class="img-fluid"> </div>
      ...
      <div class="col-md-4 blog-box">
        <div class="blog-image-block"> <img src="content/home/img/blog-02.jpg" alt="" class="img-fluid"> </div>
        <h3 class="blog-title"><small>Benefits</small><a href="#">Happiness is nothing more than good health</a></h3>
        <p class="blog-content">Our greatest happiness does not depend on the condition of life</p>
      </div>
      <div class="col-md-4 blog-box">
        <div class="blog-image-block"> <img src="content/home/img/blog-03.jpg" alt="" class="img-fluid"> </div>
          ...
          <div class="iso-box-section wow fadeInUp" data-wow-delay="0.9s">
            <div class="iso-box-wrapper col4-iso-box">
              <div class="iso-box london paris ny col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/home/img/photo-gallery-01.jpg" data-lightbox-gallery="food-gallery"> <img src="content/home/img/photo-gallery-01.jpg" class="fluid-img" alt="Gallery">
              ...
              <div class="iso-box london ny hn col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/home/img/photo-gallery-02.jpg" data-lightbox-gallery="food-gallery"> <img src="content/home/img/photo-gallery-02.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box hn col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/home/img/photo-gallery-03.jpg" data-lightbox-gallery="food-gallery"> <img src="content/home/img/photo-gallery-03.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box london col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/home/img/photo-gallery-04.jpg" data-lightbox-gallery="food-gallery"> <img src="content/home/img/photo-gallery-04.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box ny col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/home/img/photo-gallery-05.jpg" data-lightbox-gallery="food-gallery"> <img src="content/home/img/photo-gallery-05.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
              ...
              <div class="iso-box paris lunch col-md-4 col-sm-6">
                <div class="gallery-thumb"> <a href="content/home/img/photo-gallery-06.jpg" data-lightbox-gallery="food-gallery"> <img src="content/home/img/photo-gallery-06.jpg" class="fluid-img" alt="Gallery">
                  <div class="gallery-overlay">
                    <div class="gallery-item"> <i class="fa fa-search"></i> </div>
                  </div>
                  </a> </div>
